import{j as e,m as n,A as v}from"./vendor-motion-DUaGIWt9.js";import{u as w,r as s}from"./vendor-react-B7qeOA6I.js";import{u as k}from"./index-BPndQoDB.js";import{i as D,A as S,h as C,O as I,Q as A}from"./vendor-icons-3IwNmZsQ.js";const l=[{id:"myfxblue",label:"myfxblue_outlook.exe",icon:D},{id:"myfxbook",label:"myfxbook_outlook.exe",icon:S}],F=()=>{const{user:r,isLoading:c}=k(),p=w(),[a,f]=s.useState(!1),[o,b]=s.useState("myfxblue"),[i,d]=s.useState(!1);if(s.useEffect(()=>{!c&&(!r||!["admin","moderator"].includes(r.role||""))&&p("/")},[r,c,p]),c||!r||!["admin","moderator"].includes(r.role||""))return null;const h=()=>{f(!a)},m=t=>{b(t),d(!1)},u=l.find(t=>t.id===o)||l[0],g=`
    <style>
