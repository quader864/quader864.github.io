import{j as e,m as i,A as v}from"./vendor-motion-Cka5gROm.js";import{r as c,L as u}from"./vendor-react-DYIp3GNO.js";import{b as w}from"./index-B-EJBSxR.js";import{P as k}from"./PageLoader-RRqoxkkU.js";import{J as S,j as D,H as C,g as I,A as j,f as A,$ as T,a0 as N}from"./vendor-icons-BrFQ56yb.js";import"./vendor-gsap-CzGW6FVa.js";import"./vendor-three-B3rW0ZLE.js";const s=[{id:"myfxblue",label:"myfxblue_outlook.exe",icon:I},{id:"myfxbook",label:"myfxbook_outlook.exe",icon:j}],M=()=>{const{user:r,isLoading:g}=w(),[a,b]=c.useState(!1),[o,f]=c.useState("myfxblue"),[n,l]=c.useState(!1);if(g)return e.jsx(k,{});if(!(r&&(r.role==="admin"||r.role==="moderator")))return e.jsx("div",{className:"min-h-[85vh] flex items-center justify-center px-4 py-16",children:e.jsxs(i.div,{initial:{opacity:0,scale:.95,y:15},animate:{opacity:1,scale:1,y:0},className:"max-w-md w-full bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-800 shadow-2xl text-center",children:[e.jsx("div",{className:"w-16 h-16 mx-auto mb-6 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 flex items-center justify-center text-amber-600 dark:text-amber-400",children:e.jsx(S,{size:32})}),e.jsx("h1",{className:"text-2xl font-bold text-slate-900 dark:text-white mb-2",children:"Staff Access Required"}),e.jsxs("p",{className:"text-sm text-slate-600 dark:text-slate-400 mb-8 leading-relaxed",children:["The Trader Sentiment Dashboard is an internal tool restricted to users with ",e.jsx("strong",{className:"text-slate-900 dark:text-slate-200",children:"Admin"})," or ",e.jsx("strong",{className:"text-slate-900 dark:text-slate-200",children:"Moderator"})," privileges."]}),e.jsxs("div",{className:"flex flex-col gap-3",children:[r?e.jsxs("div",{className:"p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl text-xs text-slate-500 mb-2",children:["Signed in as ",e.jsx("span",{className:"font-semibold text-slate-800 dark:text-slate-200",children:r.email})," (Role: ",e.jsx("span",{className:"capitalize font-semibold text-amber-600 dark:text-amber-400",children:r.role||"user"}),")"]}):e.jsxs(u,{to:"/auth/login",className:"w-full flex items-center justify-center gap-2 py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-xl transition-colors shadow-lg shadow-indigo-600/20",children:[e.jsx(D,{size:18}),"Sign In to Staff Account"]}),e.jsxs(u,{to:"/",className:"w-full flex items-center justify-center gap-2 py-3 px-4 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-medium rounded-xl transition-colors",children:[e.jsx(C,{size:18}),"Return to Home"]})]})]})});const h=()=>{b(!a)},d=t=>{f(t),l(!1)},p=s.find(t=>t.id===o)||s[0],m=`
    <style>
  ...
  `;return e.jsx("div",{className:"min-h-screen pt-24 pb-12 bg-slate-50 dark:bg-slate-950 px-4 sm:px-6 lg:px-8 transition-colors duration-500",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsx(i.h1,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},className:"text-4xl font-bold text-slate-900 dark:text-white mb-4",children:"Market Sentiment"}),e.jsx(i.p,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.1},className:"text-slate-600 dark:text-slate-400",children:"Live community outlook for major currency pairs."})]}),e.jsxs(i.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.2},className:"bg-slate-900 rounded-xl overflow-hidden shadow-2xl border border-slate-800",children:[e.jsxs("div",{className:"bg-slate-800 flex items-center justify-between border-b border-slate-700 min-h-[48px] relative z-20",children:[e.jsxs("div",{className:"flex items-center flex-1 min-w-0",children:[e.jsxs("div",{className:"flex gap-1.5 shrink-0 px-4",children:[e.jsx("div",{className:"w-3 h-3 rounded-full bg-red-500/80"}),e.jsx("div",{className:"w-3 h-3 rounded-full bg-yellow-500/80"}),e.jsx("div",{className:"w-3 h-3 rounded-full bg-green-500/80"})]}),e.jsxs("div",{className:"md:hidden relative ml-2",children:[e.jsxs("button",{onClick:()=>l(!n),className:"flex items-center gap-2 text-xs font-mono text-accent-400 bg-slate-900/50 hover:bg-slate-900 px-3 py-1.5 rounded-md border border-slate-700 transition-colors",children:[e.jsx(p.icon,{size:14}),e.jsx("span",{className:"truncate max-w-[120px]",children:p.label}),e.jsx(A,{size:14,className:`transition-transform duration-200 ${n?"rotate-180":""}`})]}),e.jsx(v,{children:n&&e.jsx(i.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,y:10},className:"absolute top-full left-0 mt-2 w-56 bg-slate-800 border border-slate-700 rounded-lg shadow-xl overflow-hidden py-1 z-50",children:s.map(t=>e.jsxs("button",{onClick:()=>d(t.id),className:`w-full flex items-center gap-3 px-4 py-3 text-xs font-mono text-left transition-colors ${o===t.id?"bg-slate-700/50 text-accent-400 border-l-2 border-accent-500":"text-slate-400 hover:bg-slate-700 hover:text-slate-200 border-l-2 border-transparent"}`,children:[e.jsx(t.icon,{size:14}),t.label]},t.id))})})]}),e.jsx("div",{className:"hidden md:flex items-end h-full pt-2",children:s.map(t=>e.jsxs("button",{onClick:()=>d(t.id),className:`flex items-center gap-2 px-4 py-2.5 rounded-t-lg text-xs font-mono transition-colors border-t border-x -mb-[1px] ${o===t.id?"bg-slate-900 text-accent-400 border-slate-700 border-b-slate-900 z-10":"bg-slate-800 text-slate-500 border-transparent hover:bg-slate-700 hover:text-slate-300"}`,children:[e.jsx(t.icon,{size:14}),e.jsx("span",{children:t.label})]},t.id))})]}),e.jsx("div",{className:"pr-4 flex items-center",children:e.jsx("button",{onClick:h,className:`flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-medium transition-colors whitespace-nowrap ${a?"bg-accent-600 text-white":"bg-slate-700 text-slate-300 hover:bg-slate-600"}`,title:a?"Click to disable interaction and enable smooth scroll":"Click to interact with widget",children:a?e.jsxs(e.Fragment,{children:[e.jsx(T,{size:14}),e.jsx("span",{className:"hidden sm:inline",children:"Interactive"})]}):e.jsxs(e.Fragment,{children:[e.jsx(N,{size:14}),e.jsx("span",{className:"hidden sm:inline",children:"Scroll Mode"})]})})})]}),e.jsxs("div",{className:"bg-slate-950 w-full relative h-[75vh] min-h-[500px]",onClick:()=>n&&l(!1),children:[o==="myfxbook"&&e.jsx("iframe",{srcDoc:x,title:"MyFxBook Widget",className:`absolute inset-0 w-full h-full border-none transition-all duration-300 opacity-100 visible z-10 ${a?"pointer-events-auto":"pointer-events-none"}`,sandbox:"allow-scripts allow-same-origin allow-popups allow-forms allow-modals"}),o==="myfxblue"&&e.jsx("iframe",{srcDoc:y,title:"MyFxBlue Widget",className:`absolute inset-0 w-full h-full border-none transition-all duration-300 opacity-100 visible z-10 ${a?"pointer-events-auto":"pointer-events-none"}`,sandbox:"allow-scripts allow-same-origin allow-popups allow-forms allow-modals"}),!a&&e.jsx("div",{className:"absolute inset-0 flex items-center justify-center pointer-events-none opacity-0 hover:opacity-100 transition-opacity duration-300 z-20",children:e.jsx("div",{className:"bg-black/60 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium border border-white/10",children:'Switch to "Interactive" to click links'})})]})]})]})})};export{M as default};
