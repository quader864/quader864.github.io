import{c as f,N as w,O as k,k as n,Q as D,z as S,x as e,y as s,B as C,A as I}from"./index-BtcceHd_.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U=[["path",{d:"M14 4.1 12 6",key:"ita8i4"}],["path",{d:"m5.1 8-2.9-.8",key:"1go3kf"}],["path",{d:"m6 12-1.9 2",key:"mnht97"}],["path",{d:"M7.2 2.2 8 5.1",key:"1cfko1"}],["path",{d:"M9.037 9.69a.498.498 0 0 1 .653-.653l11 4.5a.5.5 0 0 1-.074.949l-4.349 1.041a1 1 0 0 0-.74.739l-1.04 4.35a.5.5 0 0 1-.95.074z",key:"s0h3yz"}]],j=f("mouse-pointer-click",U),l=[{id:"myfxblue",label:"myfxblue_outlook.exe",icon:D},{id:"myfxbook",label:"myfxbook_outlook.exe",icon:S}],F=()=>{const{user:o,isLoading:c}=w(),p=k(),[a,b]=n.useState(!1),[r,h]=n.useState("myfxblue"),[i,d]=n.useState(!1);if(n.useEffect(()=>{!c&&(!o||!["admin","moderator"].includes(o.role||""))&&p("/")},[o,c,p]),c||!o||!["admin","moderator"].includes(o.role||""))return null;const x=()=>{b(!a)},m=t=>{h(t),d(!1)},u=l.find(t=>t.id===r)||l[0],g=`
    <style>
