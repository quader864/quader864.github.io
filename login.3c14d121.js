...
function setLoadingState(form, isLoading) {
    ...
    if (submitBtn) {
        ...
        submitBtn.innerHTML = isLoading ? '<span class="spinner-border spinner-border-sm"></span> Processing...' : submitBtn.textContent;
    }
}
// Main application
document.addEventListener('DOMContentLoaded', ()=>{
    const API_URL = 'https://api-verifier.onrender.com';
    // Login form
    ...
    if (loginForm) loginForm.addEventListener('submit', async (e)=>{
        ...
        try {
            ...
            } else showAlert(data.message || 'Login failed', false);
        } catch (err) {
    ...
    if (logoutBtn) logoutBtn.addEventListener('click', async ()=>{
        try {
            ...
            } else showAlert('Logout failed', false);
        } catch (err) {
    ...
    async function verifySession() {
        try {
          ...
          `;
            } else window.location.href = 'https://quader864.github.io/login.html';
        } catch (err) {
            console.error('Session check failed:', err);
            window.location.href = 'https://quader864.github.io/login.html';
        }
    }
});
